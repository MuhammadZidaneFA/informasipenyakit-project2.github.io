...
$nama_penyakit = mysqli_fetch_assoc($query);
    ...
    <form action="add/proses_tambah.php" method="POST" enctype="multipart/form-data">
        <div class="container">
            ...
            <div class="form-group">
                ...
                <img class="card-img-top" src="image/<?php echo $nama_penyakit['img1']; ?>" alt="Card image cap">
            ...
            <p>
                <label for="p1"></label>
                <input type="text" name="p1" value="<?php echo $siswa['p1']?>" />
            </p>

            <h3>Penyebab dan Gejala</h3>
            <p>
                <label for="p2"></label>
                <input type="text" name="p2" value="<?php echo $siswa['p2']?>" />
            </p>

            <h3>Sejarah Munculnya Pertama Kali</h3>
            <p>
                <label for="p3"></label>
                <input type="text" name="p3" value="<?php echo $siswa['p3']?>" />
            </p>

            <h3>Pencegahan Penyebaran</h3>
            <p>
                <label for="p4"></label>
                <input type="text" name="p4" value="<?php echo $siswa['p4']?>" />
            </p>

            <h3>Cara Penanganan Penyakit</h3>
            <p>
                <label for="p5"></label>
                <input type="text" name="p5" value="<?php echo $siswa['p5']?>" />
            </p>
